...
<div style={{display: "flex", justifyContent: "center"}}>
    <iframe id="odysee-iframe" width="560" height="315"
            src="https://odysee.com/$/embed/deploy-flutter-web-on-github-pages/4d9ffab969b35dff093a20d789c50dc37d93bf78?r=BJgwk1iRu2HVxyUNS1oX38aRZPJ1YbT9"
            allowFullScreen/>
</div>
...
![Initial flutter folder structure](./voyage-project-structure.webp)
...
![New Dart project in IntelliJ](./new_dart_project.webp)
...
![New Dart project in IntelliJ](./flutter-homepage.webp)

<div>
    <img style={{margin: "0 auto"}} src="./another-first-one.gif"
...
![Chingu challenge tier 3](./basic-design-tier-3.png)
...
![Digital Journal Areas](./digital-journal-areas.webp)
...
![Digital Journal Areas](./html-looks-different.webp)
...
![Colorful text in Flutter](./colorful-text.webp)
...
![Colorful text in Flutter](./error-in-ide.webp)
...
![First, cut off my Development in Flutter](./first-web-flutter.webp)
...
![The visible cut of Text and widgets warnings. ](./responsive-edges.webp)
