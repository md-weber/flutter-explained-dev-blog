...
![Flutter Project: Scrum Poker App Feature Image](/assets/2019/flutter-scrum-card-app/flutter-scrum-card-app.webp)
...
<div>
    <img style={{margin: "0 auto", boxShadow: "3px 3px 11px 0px rgba(0,0,0,0.75)"}} src="/assets/2019/flutter-scrum-card-app/scrum-poker-app.gif"
...
![MyHomepage.dart file](/assets/2019/flutter-scrum-card-app/myHomepage.webp)

And the following image represents the folder structure:
![Folder structure of our Flutter project](/assets/2019/flutter-scrum-card-app/folder-structure.png)
...
![Folder structure of our Flutter project](/assets/2019/flutter-scrum-card-app/homepage-2.webp)
...
<div>
    <img style={{margin: "0 auto", boxShadow: "3px 3px 11px 0px rgba(0,0,0,0.75)"}} src="/assets/2019/flutter-scrum-card-app/placeholder-scrum-card.webp" width={200}
...
![Build Function](/assets/2019/flutter-scrum-card-app/1-8.png)
![Grid View](/assets/2019/flutter-scrum-card-app/1-9.webp)

<div>
    <img style={{margin: "0 auto", boxShadow: "3px 3px 11px 0px rgba(0,0,0,0.75)"}} src="/assets/2019/flutter-scrum-card-app/2-1.webp" width={200}
         alt="Placeholder in flutter app to demonstrate where the elements need to go."/>
</div>
...
<div>
    <img style={{margin: "0 auto", boxShadow: "3px 3px 11px 0px rgba(0,0,0,0.75)"}} src="/assets/2019/flutter-scrum-card-app/1-10.png" width={400}
         alt="ScrumCard Widget"/>
</div>

This will now print every click on a card in a separate line in the console.

![Scrum Card](/assets/2019/flutter-scrum-card-app/1-11.webp)
...
![Switch to a stateful widget](/assets/2019/flutter-scrum-card-app/1-12.webp)

Because the new Widget is now stateful, we can change its value and the “build” method can react to these different states.

![States that are contained](/assets/2019/flutter-scrum-card-app/1-13.webp)
...
![Ternarie operators](/assets/2019/flutter-scrum-card-app/1-14-1.webp)
...
![Current state of the Parent widget](/assets/2019/flutter-scrum-card-app/1-15.webp)
...
![Current state of the ScrumCard widget](/assets/2019/flutter-scrum-card-app/1-16.webp)
![Current state of the ScrumCard widget](/assets/2019/flutter-scrum-card-app/1-17.webp)
...
![Beautiful Card design](/assets/2019/flutter-scrum-card-app/1-18.webp)
...
![Animated Switcher](/assets/2019/flutter-scrum-card-app/1-19.webp)

Ok, so let’s run our simulator or emulator and take a look how the app looks now.

<div>
    <img style={{margin: "0 auto", width: "40%", boxShadow: "3px 3px 11px 0px rgba(0,0,0,0.75)"}} src="/assets/2019/flutter-scrum-card-app/1-1-516x1024.gif"
