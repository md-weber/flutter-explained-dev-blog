...
<div style={{display: "flex", justifyContent: "center"}}>
    <iframe width="560" height="315" src="https://www.youtube.com/embed/kR0N_Ecv_b0" title="YouTube video player"
            frameBorder="0"
...
<div>
    <img style={{margin: "0 auto"}} src="/assets/2020/three-problems-ci-cd/recipe.webp" width="30%"
         alt="Demo recipe app"/>
</div>
...
![JSON to instance](/assets/2020/three-problems-ci-cd/first.webp)

Flutter tests result with Analyzer problems

![JSON to instance](/assets/2020/three-problems-ci-cd/second.webp)
...
![JSON to instance](/assets/2020/three-problems-ci-cd/third.webp)
![JSON to instance](/assets/2020/three-problems-ci-cd/fourth.webp)
...
![JSON to instance](/assets/2020/three-problems-ci-cd/building_ios.webp)
...
![JSON to instance](/assets/2020/three-problems-ci-cd/1.webp)
![JSON to instance](/assets/2020/three-problems-ci-cd/2.webp)
...
![JSON to instance](/assets/2020/three-problems-ci-cd/3.webp)
