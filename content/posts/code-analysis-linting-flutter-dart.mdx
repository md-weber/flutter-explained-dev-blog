...
![Example of our Result](/assets/code_analysis_linting/single_quote.png)
...
![On explicit null decleration the linter is showing a message](/assets/code_analysis_linting/on_explicit.png)
...
![Linter shows a warning if you could use a StringBuffer](/assets/code_analysis_linting/linter_shows_warning_string_buffer.png)

![StringBuffer provides a performant way to handle Strings](/assets/code_analysis_linting/stringbuffer_provide_performant_way.png)
...
![The prefer double quotes Rule lead to informations about usage of a double quote](/assets/code_analysis_linting/prefer_double_quotes.png)
...
![Analyzer & Linter](/assets/code_analysis_linting/analysis_options.png)
...
![Linting error appear after setting the right rules](/assets/code_analysis_linting/linting_error.png)
...
![Adding lint into our dev dependencies](/assets/code_analysis_linting/dev_dependencies.png)
The next step is to import the rules from the package into our analysis_options.yaml.
![Added the analysis_options of the lint package to our analysis_options of the project](/assets/code_analysis_linting/anlysis_options_dep.png)
...
![Full solution with overwrite of specific rules](/assets/code_analysis_linting/solution.png)
